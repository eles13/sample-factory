...
def create_env(full_env_name, env_id, cfg=None, env_config=None, start=False):
    """
    ...
    env = env_registry_entry.make_env_func(full_env_name, env_id, cfg=cfg, env_config=env_config, start=start)
    return env
